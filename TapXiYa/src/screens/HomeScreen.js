      ...
      <View style={styles.header}>
        ...
        <ScrollView>
          <View style={styles.home}>
            <Text style={styles.text1}>Desestresa tu viaje</Text>
            <View style={styles.view1}>
              <View style={styles.view8}>
                <Text style={styles.text2}>
                  Lee un libro. Toma una siesta. Mirar por la ventana
                </Text>
                <TouchableOpacity
                  onPress={() =>
                ...
                >
                  <View style={styles.button1}>
                    <Text style={styles.button1Text}>Viaja con TapXiYa</Text>
                  </View>
                </TouchableOpacity>
              </View>
            </View>
			<Image 
                style ={styles.image1}
                source = {require('../../assets/TapXiYaCar.png')}
                />
          </View>
        </ScrollView>
